...
def _updateMoorings(n_columns, fairlead, lower_column, ms, line_length=None, line_dia=None): 
    ...
    ms['line_types'][0]['mass_density'] = 113.35 * (line_dia/0.0766)**2
    ms['line_types'][0]['stiffness'] = 753.6e6 * (line_dia/0.0766)**2
    ms['line_types'][0]['breaking_load'] = 1e8  * (line_dia/0.0766)**2
